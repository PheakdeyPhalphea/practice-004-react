...
export default function FeedBackComponent() {
  return (
    <div className="max-w-screen-md bg-gray-50">
      <div className="flex items-center text-yellow-300 mx-5  ">
        <svg
          class="w-5 h-5 me-1"
          aria-hidden="true"
      ...
      <div className="flex items-center mt-6 space-x-3 rtl:space-x-reverse mx-5">
        <img
